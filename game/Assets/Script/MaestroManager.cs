...
public class MaestroManager : MonoBehaviour
{
    ...
    public bool iconaDaMostrare = true; // Parte true perch� all'inizio deve salutarti
    ...
    private void ReazioneAlCambioStato(GameState nuovoStato)
    {
        ...
        if (statoMentaleMaestro != nuovoStato)
        {
            ...
            // RIACCENDI L'ICONA (perch� ora ho una reazione diversa, es. paura o indifferenza)
    ...
    public void AttivaEventoQuadro()
    {
        if (!segretoQuadroSbloccato)
        {
            ...
            // RIACCENDI L'ICONA (perch� ho un commento sul quadro da fare)
            iconaDaMostrare = true;
        }
    }
